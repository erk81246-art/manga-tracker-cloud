...
function DetailModal({
  ...
  return (
    <motion.div
      className="fixed inset-0 z-50 flex items-end bg-black/55 p-0 md:items-center md:justify-center md:p-6"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      onClick={onClose}
    >
      <motion.div
        ...
        className="max-h-[94vh] w-full overflow-hidden rounded-t-[2rem] bg-white shadow-2xl md:max-w-3xl md:rounded-[2rem] lg:max-w-4xl"
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="relative max-h-[92vh] overflow-y-auto p-4 pt-5 md:p-6">
