...
function HeroCarousel({
  ...
  return (
    <section className="hero-showcase mb-6 overflow-hidden rounded-[2.2rem] bg-zinc-950 p-3 text-white shadow-sm md:p-5">
      ...
      <div className="relative min-h-[560px] md:min-h-[760px]">
        {featured.length > 1 && (
          <button onClick={() => move(-1)} className="absolute left-0 top-12 hidden h-[360px] w-[190px] overflow-hidden rounded-[1.7rem] opacity-45 transition hover:opacity-70 md:block lg:left-2 xl:left-6">
        ...
        {featured.length > 1 && (
          <button onClick={() => move(1)} className="absolute right-0 top-12 hidden h-[360px] w-[190px] overflow-hidden rounded-[1.7rem] opacity-45 transition hover:opacity-70 md:block lg:right-2 xl:right-6">
        ...
        <motion.div
          ...
          className="relative z-10 mx-auto overflow-hidden rounded-[2rem] border border-purple-400/40 bg-zinc-900 shadow-[0_0_32px_rgba(168,85,247,0.25)] md:w-[380px] md:max-w-full xl:w-[420px]"
        >
          ...
          <div className="relative z-10 p-5 md:p-6">
            <h1 className="line-clamp-3 text-4xl font-black leading-[0.95] tracking-tight md:text-[2.6rem]">{active.title}</h1>
            ...
            <p className="mt-4 line-clamp-3 text-sm font-medium text-white/75">{active.note || "กดรายละเอียดเพื่อดูข้อมูลและจัดการเรื่องนี้"}</p>
